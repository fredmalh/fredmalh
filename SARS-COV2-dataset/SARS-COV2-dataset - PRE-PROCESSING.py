...
Analysis of a dataset related to SARS-COV2 with Python in Jupyter Notebooks
...
df = pd.read_excel(r'C:\Users\Fred\Dropbox\DATA SCIENCE\PORTFOLIO\SARS-COV2-dataset\dataset.xlsx')
backup = df.copy()
